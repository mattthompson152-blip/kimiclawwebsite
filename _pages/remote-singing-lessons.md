---
layout: default
title: "Remote Singing Lessons for Travelers"
description: "Vocal coaching on the move for touring musicians, actors on location, and digital nomads. Learn from anywhere."
...
<section class="service-content">
  <div class="container-narrow">
    ...
    <div style="background: #1a1a1a; padding: 2rem; border-radius: 8px; margin: 3rem 0; border: 1px solid #333; text-align: center;">
      ...
      <a href="#" onclick="if(typeof widget !== 'undefined') { widget.open(); } return false;"target="_blank" rel="noopener">Contact Matt &rarr;</a>
    </div>
